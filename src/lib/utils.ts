...
=======
    github_id: props.github.login.toLocaleLowerCase(),
    lc_id: props.leetCode.username.toLocaleLowerCase(),
    lc_github: props.leetCode.githubUrl,
    totalContributions: props.totalContributions,
    totalSubmissions: props.leetCode.totalSub,
    Verified:
...
>>>>>>> Stashed changes:src/lib/utils.ts
  }
}
<<<<<<< Updated upstream:lib/utils.ts
=======
